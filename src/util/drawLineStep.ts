...
export function drawLineStepThird(
  ...
  ctx.beginPath();
  ctx.moveTo(
    measureJson.pose_landmark[0].sx - 100,
...
export function drawLineStepSixth(
  ...
  ctx.moveTo(
    Math.round(
      (measureJson.pose_landmark[7].sx + measureJson.pose_landmark[8].sx) / 2,
    ),
    Math.round(
      (measureJson.pose_landmark[7].sy + measureJson.pose_landmark[8].sy) / 2,
    ),
  );
  ctx.lineTo(
    measureJson.pose_landmark[11].sx,
