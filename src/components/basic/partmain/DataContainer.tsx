import type {  IMeasureBasic } from "../../../types/basic";
import { PartMainData } from "./Data";

export function PartMainDataContainer({data}: {data: IMeasureBasic}) {

  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] rounded-xl border border-sub200 overflow-hidden bg-white text-sub800 m-2">
      <div className="flex flex-col">

        <div className="grid grid-cols-[1fr_3fr] items-center text-center border-b border-sub200 text-sm h-fit">
          {/* 왼쪽: 상체분석 */}
          <div className="flex h-8  bg-sub150 font-bold items-center justify-center text-sub800 text-sm md:text-base leading-tight ">
            상체분석
          </div>

          <div className="grid grid-cols-[30%_70%] items-center text-sm md:text-base ">
            <span className="text-sub800 font-medium">측정 기준</span>
            
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center w-full text-sub300">
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-[1fr_3fr] items-center text-center border-y md:border-b border-sub200 text-sm h-fit">
          {/* 오른쪽: 하체분석 */}
          <div className="flex h-8 bg-sub150 font-bold items-center justify-center text-sub800 text-sm md:text-base leading-tight ">
            하체분석
          </div>
          ...
          <div className="grid grid-cols-[30%_70%] text-sm md:text-base  items-center">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center w-full text-sub300 relative justify-center">
