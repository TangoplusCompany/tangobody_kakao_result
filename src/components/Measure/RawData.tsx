    ...
    <div className="w-full table table-fixed min-w-0 rounded-xl border border-sub-200">
      <div className="flex flex-col overflow-x-auto overflow-y-hidden w-full min-w-0 scrollbar-none [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-[1.5fr_1fr_1.25fr] md:grid md:grid-cols-[18%_10%_12%_60%] items-center rounded-t-xl border-b border-sub-200 bg-sub-100 dark:bg-muted py-2">
            ...
            <span className="hidden md:block text-base text-sub600 dark:text-muted-foreground px-4">분석설명</span>
          </div>

          <div className="flex flex-col">
            {/* 왼쪽(상단) */}
            <div className={`grid grid-cols-[1.5fr_1fr_1.25fr] md:grid md:grid-cols-[18%_10%_12%_60%] items-center h-full divide-x divide-sub-200 last:divide-none`}>
              <div className={`grid items-center h-full ${data1 && 'divide-y divide-sub-200'}`}>
