...
import StaticContainer from "./Media/StaticContainer";
import DynamicContainer from "./Media/DynamicContainer";
...
export default function MainContainer({data}: {data: IReportDetail | undefined}) {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full grid grid-cols-3 md:grid-cols-6 gap-0.5 md:gap-1 p-2 rounded-t-2xl md:rountded-t-lg border-t-2 border-sub-150 my-2">
        {tabs.map((tab, index) => {
      ...
      <div className="w-full pt-4 mb-36">
